                    ...
                    <div className="col-lg-10 col-xl-8">
                      <div className="row">
                        <div className="col-lg-4 d-flex justify-content-center">
                          <img src="../../public/images/dollubollu.jpg" className="rounded-circle shadow-1 mb-2 mb-lg-0" alt="woman avatar" width="100" height="100" />
                        </div>
                ...
                <div className="carousel-item">
                  <div className="row d-flex justify-content-center">
                    <div className="col-lg-10 col-xl-8">
                      <div className="row">
                        <div className="col-lg-4 d-flex justify-content-center">
                          <img src="../../public/images/monneo.jpg" className="rounded-circle shadow-1 mb-2 mb-lg-0" alt="woman avatar" width="100" height="100" />
                        </div>
                        <div className="col-9 col-md-9 col-lg-7 col-xl-8 text-center text-lg-start mx-auto mx-lg-0">
                ...
                <div className="carousel-item">
                  <div className="row d-flex justify-content-center">
                    <div className="col-lg-10 col-xl-8">
                      <div className="row">
                        <div className="col-lg-4 d-flex justify-content-center">
                          <img src="../../public/images/vahcy.jpg" className="rounded-circle shadow-1 mb-2 mb-lg-0" alt="woman avatar" width="100" height="100" />
                        </div>
                        <div className="col-9 col-md-9 col-lg-7 col-xl-8 text-center text-lg-start mx-auto mx-lg-0">
